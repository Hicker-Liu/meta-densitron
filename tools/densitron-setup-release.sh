...
usage()
{
    echo -e "\nUsage: source dm-setup-release.sh
...
echo "#Densitron Yocto layer" >> $BUILD_DIR/conf/bblayers.conf
echo "BBLAYERS += \" \${BSPDIR}/sources/meta-densitron \"" >> $BUILD_DIR/conf/bblayers.conf
